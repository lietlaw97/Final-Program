        ...
        while True:
            if self.contents.clicked_record:
                try:
                    ...
                    print("Audio recorded.")  # Debug statement
                    text = self.recognizer.recognize_google(audio)
                    text = text.lower()
                    print("Recognized text:", text)  # Debug statement
                    self.process_text(text)
                    break
                except sr.UnknownValueError:
                    self.contents.text_string.configure(text="Speech not recognized. Please try again.")
                    self.contents.reset_mic_btn()
                    break
                    ...
                    print(f"Error in get_speech: {e}")
                    self.contents.text_string.configure(text="An error occurred. Please try again.")
                    self.contents.reset_mic_btn()
                    break
